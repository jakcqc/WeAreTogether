...
DEFAULT_MODELS = (
    ...
    ModelDefinition(
        ...
        provider="ollama",
        upstream_model="gemma4:e2b",
        description="Latest Gemma 4 edge model (E2B) for local multimodal workloads.",
        remote=False,
        provider_options={"model_family": "gemma4", "min_vram_gb": 7.2},
    ),
    ModelDefinition(
        ...
        description="Latest Gemma 4 edge model (E4B) with stronger quality than E2B.",
        remote=False,
        provider_options={"model_family": "gemma4", "min_vram_gb": 9.6},
    ),
    ModelDefinition(
        ...
        description="Latest Gemma 4 MoE workstation model (26B A4B) for stronger reasoning.",
        remote=False,
        provider_options={"model_family": "gemma4", "min_vram_gb": 18.0},
    ),
    ModelDefinition(
        ...
        description="Latest Gemma 4 dense workstation model (31B) for maximum local quality.",
        remote=False,
        provider_options={"model_family": "gemma4", "min_vram_gb": 20.0},
    ),
    ModelDefinition(
